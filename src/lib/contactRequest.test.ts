...
const lead = { name: 'Ana Lima', email: 'ana@empresa.com.br', phone: '(11) 99999-0000', message: 'Quero criar um kit para onboarding.', responseChannel: 'whatsapp' as const, privacyAccepted: true };
...
describe('contato rápido', () => {
  ...
  it('prepara fallback de e-mail sem depender de infraestrutura', () => {
    ...
    expect(decodedHref).toContain('Canal preferido: whatsapp');
