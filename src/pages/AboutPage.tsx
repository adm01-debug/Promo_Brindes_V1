      ...
      <section className="section about-process">
        <div className="container">
          ...
          <ol className="about-steps">
            ...
            <li><span>03</span><Headphones /><h3>Curadoria</h3><p>Nossa equipe analisa alternativas e ajuda a refinar a escolha.</p></li>
