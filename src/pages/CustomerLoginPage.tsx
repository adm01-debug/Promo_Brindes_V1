  ...
  return (
    <div className="customer-auth-page">
      ...
      <section className="customer-auth-card" aria-labelledby="customer-access-title">
        ...
        {(mode === 'email' || mode === 'password') && <div className="customer-auth-tabs" role="tablist" aria-label="Forma de acesso"><button type="button" role="tab" aria-selected={mode === 'email'} onClick={() => { setMode('email'); setError(''); }}>Link ou código</button><button type="button" role="tab" aria-selected={mode === 'password'} onClick={() => { setMode('password'); setError(''); }}>Senha</button></div>}
