    ...
    <>
      ...
      <header className="content-hero">
        <div className="container content-hero__grid">
          ...
          <p>Se você já sabe o que procura, conte para a gente. Se ainda não sabe, nosso time de especialistas ajuda a transformar o contexto da sua ação em possibilidades.</p>
        </div>
      </header>
      <section className="section contact-section">
        <div className="container contact-grid">
          <div className="contact-card contact-card--primary"><span><Phone /></span><small>Telefone</small><a href="tel:+551146375517">(11) 4637-5517</a><p>Para conversar diretamente com nosso time de especialistas.</p></div>
      ...
      <ConversationForm />
      <section className="contact-prompt"><div className="container contact-prompt__inner"><div><span className="section-kicker section-kicker--light">Prefere começar pelos produtos?</span><h2>Monte uma seleção visual antes de falar com nosso time de especialistas.</h2><p>Você envia códigos, cores e quantidades em uma única solicitação.</p></div><Link className="button button--light button--large" to="/catalogo">Abrir catálogo <ArrowRight size={18} /></Link></div></section>
    </>
  );
}
