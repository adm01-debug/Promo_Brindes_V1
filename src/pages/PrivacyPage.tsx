  ...
  return (
    <>
      ...
      <article className="container legal-content">
        ...
        <section><h2>3. Catálogo e armazenamento local</h2><p>A sua seleção pode ser salva no armazenamento local do navegador para que ela não seja perdida ao fechar ou atualizar a página. Ela não contém preço nem dados pessoais e pode ser removida a qualquer momento em “Minha seleção”.</p></section>
