...
- Dados: 7.524 produtos ativos disponíveis na validação remota final; o contrato público continua sem expor preço, estoque ou identificadores de fornecedor.
...
- Borda HTTP: corpos JSON malformados, binários, não serializáveis ou rejeitados pelo getter de parsing da plataforma são normalizados para erro 400 e nunca chegam ao banco.
